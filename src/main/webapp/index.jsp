...
<head manifest="tetris.manifest">     
    ...
    <title>HOVEY ENERGY - Login</title> 
...
.user-icon {
	top:31px; /* Positioning fix for slide-in, got lazy to think up of simpler method. */
...
$(document).ready(function(){
	 ...
	 $('#pass').focusout(function(){
		...
		if(pwd==""||pwd==null||pwd=="Password"){
			...
			$('#text_password').attr('name',"j_password");
...
<body>
	<div id="login_head_text" style=" padding: 15px 0 0 15px;"> 
		<h1><a href="./home.do"><img src="images/logo.png"/></a></h1> 
	</div>
	...
	<form name="login-form" class="login-form" action="<c:url value="/j_spring_security_check" />" method="POST" onSubmit="return validateLogin()">
		...
		<input name="j_username" type="text" class="input username"  required="required" value="Username" id="username" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" />
		
		
		<label class="gd" id="Passwd" style="margin-top: 14px;">*</label>
			
				<input  type="password" class="input password" style="display: none;margin-top: 4px;" id="pass"  />
				   <input id="text_password" name="j_password" class="input password" style="margin-top: 4px;" value="Password" type="text" />
		...
		<div class="bottom_link">
					<!-- <div class="forgot_pass">
						<a href="./forGotPassword.do" class="forgot_pass">Forgot Your Password?</a>
					</div> -->
				...
				<!-- <div class="bottom_link">
				<div class="forgot_pass">
					<span style="color:#222;margin:0">Don't have an account?</span>
				</div>
				 <div class="login_button">
                                        <a href="./register.do" class="register_button"> Register</a>
                               </div>
			</div>
					 -->
