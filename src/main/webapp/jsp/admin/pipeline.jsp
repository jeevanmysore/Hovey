			...
			<!-- Modiified by Jeevan on July 18,2013 to add States and Utility for Dynamic Search -->
				...
				<!-- Modiified by Jeevan on July 18,2013 to add States and Utility for Dynamic Search -->   
				   ...
				   <div class="fc-text" style="margin-top:15px;clear:both">Agent Name:</div>
						...
						<div class="fc-text" style="text-align: left;margin-left: 50px;margin-top:15px;width: 60px;">SVC Type:</div>
						<select style="border:1px solid #ccc; margin-left:33px;   height: 25px; width: 125px; margin-top: 11px;float: left ;" name="serviceType">			  
			  				<option value="">- Select -</option>
                                              ...
                                              <table class="pptbl" cellpadding="1" cellspacing="1" bgcolor="#B2B2B2" style="border-right: 1px solid #c8cfd2; padding: 3px 1px;">
                                               ...
                                               <c:forEach var="order" items="${orders}">  
                                                ...
                                                <td align="center" bordercolor="#666666" >
                                                	...
                                                	<!--  Modified by Bhagya on September 29, 2014 as per clients need to have terms fromn 1 to 36 -->
                                                		<c:forEach var="termcount" begin="1" end="36" step="1">
