...
<div id="content">
	 ...
	 <div id="wrapper">
		...
		<div class="data-input-form">
			...
			<form class="form-horizontal1 form-validate1" method="POST" action="/hoveyenergy/admin/resetagentpassword.do" onSubmit="return validatePass()">
									...
									<div style="text-align: center;margin-top: 20px;margin-bottom: 20px;clear: both;">
										...
										<a href="/hoveyenergy/admin/agents.do" class="btn btn-undo" type="button" style="margin-left: 10px;">Cancel</a>
