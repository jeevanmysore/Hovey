...
<%@ include file="header.jsp" %>	
 <div id="content">
	...
	<div class="content">
			...
			<input type="text" required="required" class="input Password" name="username" id="username" value="Username" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" style="text-transform: none;"/>
			<div style="margin-top:25px;height: 16px;">
		    	<label class="gd" id="Passwd">*</label>
		    </div>
		<input  type="password" class="input password" style="display: none;margin-top: 0px;" id="pass"  />
		...
		<div style="margin-top:25px;height: 27px;">
		...
		<div style="margin-top:25px;height: 12px;">
		...
		<input class="input password" type="text" required="required" style="margin-top: 0px;" name="lastname" value="Last name" id="lname" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)"/>
		
		<div style="margin-top:23px;height: 14px;">
			<label class="gd"  id="cty"></label>
		</div>
		<input class="input password" type="text"  name="city" value="City" id="city" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" style="margin-top: 0px;"/>
...
<option>Wyoming</option>
		...
		<input  class="input password" type="text" name="zipcode" value="Zip Code" id ="zip" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" style="margin-top:0px"/>
		...
		<input  class="input password" type="text"  id="email" name="email" value="Email Adress" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" style="margin-top:0px;text-transform: none;"/>
		<div style="margin-top:25px;height: 14px;">
			<label class="gd" id= "agent">*</label>
		</div>
		<input  class="input password" type="text"  name="agentNumber" value="Agent Number" id ="agentNumbr" onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" style="margin-top:0px;text-transform: none;"/>
