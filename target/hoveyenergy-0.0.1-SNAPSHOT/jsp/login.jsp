...
<body>
	...
	<form name="login-form" class="login-form" action="<c:url value="/j_spring_security_check" />" method="POST" onSubmit="return validateLogin()">
		...
		<input name="j_password" type="password" class="input password" required="required" value="Password" id="pass"  onFocus="hide_placeholder(this)" onBlur="show_placeholder(this)" />
		...
		<div class="bottom_link">
				...
				<div class="forgot_pass">
				 ...
				 <div class="login_button">
                                        <a href="./register.do"><button type="button" class="register_button"> Register</button></a>
                               </div>
			</div>
